...
namespace new123.Models
{
    ...
    public partial class Survey
    {
        ...
        public void createMG()
        {
            ...
            string newsurstring = "{\"index\":" + this.SurveyID.ToJson() + ", \"sname\": " + this.SurveyName.ToJson() + ", \""+this.SurveyJson+"\": \"\"" + ", nextqid: 1, \"pages\": [{page_title: \"untitle\", shortdescription: \"\", questions:[]}]}";
